                          ...
                          <div  class="container-fluid">
                            ...
                            <div class="row">
                              <div class="col-md-6">                  
                                ...
                                <input type="number" class="form-control" id="preçoCarvao" name="preçoCarvao" placeholder="Preço">
                              </div>  
                              <div class="col-md-6 ">                                  
                                  ...
                                  <?php if(isset($carvoes)){ ?>
                                    <?php if(mysqli_num_rows($carvoes) > 0): ?>
                                      <?php while($uni = mysqli_fetch_assoc($carvoes)): ?> 
                                        <?php echo '<tr><td>'. $uni["id_carvao"] . '</td><td>' . $uni["marca"] . '</td><td>' . $uni["preco"] . '</td><td>' . $uni["quantidade"] .'</td><td>' . '<a href=carvaoEdit.php?id='.$uni["id_carvao"]. '>Editar</a>' .  ' ' . '<button class="btn btn-primary" type="submit" id="excluir" class="floated" name="excluir" value='.$uni["id_carvao"].'>Excluir</button>' . '</td></tr>' ?>
