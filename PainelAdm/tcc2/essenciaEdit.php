...
if ($_SERVER["REQUEST_METHOD"] == "GET"){
    ...
    if(isset($_GET["id"])){  
      ...
      $sql = "SELECT * from essencia where id_essencia= '$id'";

      if(!($essencia = mysqli_query($conn,$sql))){
                          ...
                          <div  class="container-fluid">
                            ...
                            <div class="row">
                              <div class="col-md-6">                  
                                ...
                                <input type="text" class="form-control" id="categoriaEssencia" name="categoriaEssencia" value="<?php echo $essencia["categoria"] ?>">
