...
if ($_SERVER["REQUEST_METHOD"] == "GET"){
  ...
  if(isset($_GET["cadastrar"])){
    ...
    }elseif(isset($_GET["preçoEssencia"])) {
      $preçoEssencia = ($_GET["preçoEssencia"]);
    ...
    }elseif(isset($_GET["saborEssencia"])) {
      $saborEssencia = ($_GET["saborEssencia"]);
    ...
    }elseif (isset($_GET["categoriaEssencia"])) {
      $categoriaEssencia = ($_GET["categoriaEssencia"]);
                      ...
                      <form  method="GET" action="#" > 
                        <div class="row">
                          <div  class="container-fluid">
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-6 ">  
                                ...
                                <br>  
                                <button class="btn btn-primary" id="cadastrar" class="floated" name="cadastrar" onclick="obrigatorioCadastro();showDiv()">Cadastrar</button>
                                <button class="btn btn-primary" id="pesquisar" class="floated" name="pesquisar" onclick="obrigatorioPesquisa();showDiv()">Pesquisar</button>  
                              </div>
                            </div>               
                          </div>
                          ...
                          <div class="table-responsive" id="conteudo">
                            <table class="table table-bordered" id="tableConsulta" width="100%" cellspacing="0">
                              <thead>
                                <tr>
                                  <th>ID Essência</th>
                                  <th>Categoria</th>
